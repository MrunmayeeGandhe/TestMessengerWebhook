...
const PAGE_ACCESS_TOKEN = "EAAgfCh3cc9YBANo5oLFisirJmJnnqEXj9xISLTZAnlwbof8kZB0w7jsCiSSMe6J36ZCGOnKbqPvBvJOYHONTCTEXyZB2PfUqIisDA5lxkQCLqk1MsRf0HjJCNt0iuViky5WhAdDasjVf1MZBi35W8ibAKzvLZBZBXJ9YO4oIv6dqwZDZD";
...
app.post('/webhook', (req, res) => { 
    ...
    if (body.object === 'page') {
      ...
      body.entry.forEach(function(entry) {
        ...
        console.log("optin code", webhook_event.optin);
        // Get the sender PSID
